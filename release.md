...
```bash
curl -L "https://github.com/TrentonAdams/jira-cli-tools/releases/download/1.1.2-RC8/jira-cli-tools-linux-x64.tar.gz" > jira-cli-tools-linux-x64.tar.gz;
...
```bash
curl -L "https://github.com/TrentonAdams/jira-cli-tools/releases/download/1.1.2-RC8/jira-cli-tools-macos-x64.tar.gz" > jira-cli-tools-macos-x64.tar.gz;
